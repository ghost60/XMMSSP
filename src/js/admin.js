    ...
    return (<div>
      <div className='products-info-c'>
        <div className='product-info--left'>
          <div className='product-info--col'><label>党团建设上传地址</label><span>ROOT\upload\img\dtword</span></div>
          <div className='product-info--col'><label>首页轮播图上传地址</label><span>ROOT\upload\indexPic</span></div>
        </div>
...
Products.defaultProps = {
  lists: {
    szyb: [{
      ...
      name: '台湾海峡(海面风)',
      location: 'ROOT\\upload\\img\\HMFTWHX',
      remark: '手动上传'
    }, {
      name: '台湾海峡(海浪)',
      location: 'ROOT\\upload\\img\\HLTWHX',
      remark: '手动上传'
    }, {
      name: '厦金海域',
      location: 'ROOT\\upload\\img\\XJHY',
      remark: '手动上传'
    }, {
      name: '两马海域',
      location: 'ROOT\\upload\\img\\LMHY',
      remark: '手动上传'
    }, {
      name: '台湾海峡(海流)',
      location: 'ROOT\\upload\\img\\HLTWHX',
      ...
      name: '小区(海流)',
      location: 'ROOT\\upload\\img\\HLXQ',
      remark: '手动上传'
    }, {
      name: '台湾海峡(潮汐)',
      location: 'ROOT\\upload\\img\\CXTWHX',
      remark: '手动上传'
    }, {
      name: '小区(潮汐)',
      location: 'ROOT\\upload\\img\\CXXQ',
      remark: '手动上传'
    }],
    hyyb: [{
      name: '海浪水温预报',
      ...
      name: '风暴潮动画示意图',
      location: 'ROOT\\upload\\img\\FBCDHSYT',
      remark: '自动上传'
    }, {
      name: '海浪动画示意图',
      location: 'ROOT\\upload\\img\\HLDHSYT',
      remark: '自动上传'
    }, {
      name: '滨海旅游区预报',
      location: '数据库',
      ...
      name: '海浪预警报单',
      location: 'ROOT\\upload\\img\\yjword',
      remark: '自动上传'
    }, {
      name: '风暴潮预警报单',
      location: 'ROOT\\upload\\img\\yjword',
    ...
    hxyb: [{
      name: 'xml',
      location: 'ROOT\\upload\\download\\xml',
      remark: '手动上传'
    }, {
      name: 'xls',
      location: 'ROOT\\upload\\download\\xls',
      remark: '手动上传'
    }]
  }
}
