...
export class TabsPanel1 extends React.Component {
  ...
  constructor (props) {
    ...
    this.mapCfg = this.props.mapCfg || [
            ...
            { x: 216, y: 161, title: '台湾海峡北部' },
            { x: 162, y: 253, title: '台湾海峡南部' }
    ]
  }
  componentDidMount () {
    $.ajax({
        ...
        <div className={'tab-panel--right ' + this.props._className}>
          ...
          <div className='tab-panel-info'>
            ...
            <div className='tab-panel--tips'>
              <div dangerouslySetInnerHTML={{ __html: '微浪&lt0.1m' }} />
              <div dangerouslySetInnerHTML={{ __html: '0.1=&lt小浪&lt0.5m' }} />
              <div dangerouslySetInnerHTML={{ __html: '0.5=&lt轻浪&lt1.25m' }} />
              <div dangerouslySetInnerHTML={{ __html: '1.25=&lt中浪&lt2.5m' }} />
              <div dangerouslySetInnerHTML={{ __html: '2.5=&lt大 浪&lt4m' }} />
              <div dangerouslySetInnerHTML={{ __html: '4=&lt巨浪&lt6m' }} />
              <div dangerouslySetInnerHTML={{ __html: '6=&lt狂狼&lt9m' }} />
              <div dangerouslySetInnerHTML={{ __html: '9=&lt狂涛&lt14m' }} />
              <div dangerouslySetInnerHTML={{ __html: '怒涛&gt=14m' }} />
            </div>
          </div>
        </div>
      </div>
