...
class Show extends React.Component {
  ...
  render () {
    var sdata = this.state.filelist.slice((this.state.current - 1) * 12, (this.state.current - 1) * 12 + 12)
    const list = sdata.map((li, i) => {
      return <div className='gzdt_show_li' key={i}>
        <Link to={`wordshow/${this.props.type}/queryWord/${li.fileName.split('.')[0]}--0`}>
